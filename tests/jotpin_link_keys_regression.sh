...
cp "$ROOT_DIR/tests/fixtures/markdown-image.svg" "$TEST_TMP_DIR/home/Documents/Notes/markdown-image.svg"
sed 's/width="96" height="48"/width="1200" height="400"/' "$ROOT_DIR/tests/fixtures/markdown-image.svg" > "$TEST_TMP_DIR/home/Documents/Notes/large-image.svg"
...
printf '%s\n' \
  ...
  'PASS: Settings dismisses outside, keeps inside clicks, and changes text size without editing notes'

printf 'PASS: typing on the blank row after a checklist preserves paragraphs and undo\n'
